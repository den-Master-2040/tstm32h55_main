...
set "CORE=freedv_api ofdm ofdm_mode mpdecode_core phi0 interldpc gp_interleaver filter freedv_700 kiss_fft kiss_fftr modem_stats pack codec2_fifo varicode freedv_data_channel"
